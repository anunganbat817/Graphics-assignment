...
var lefteyeposition = {
  type: 'v3',
  value: new THREE.Vector3(-0.18, 2.45, -0.75)
}
...
var left = new THREE.Mesh(laserGeometry, leftLaserMaterial);
// left.parent = worldFrames[Mode.LASERS];
// left.position.set(0.0, 0.0, 0.0);
// left.rotation.x = 0.0;
// left.rotation.y = 0.0;
// left.rotation.z = 0.0;
// left.scale.set(1.0, 1.0, 1.0);
scenes[Part.LASERS].add(left);

var right = new THREE.Mesh(laserGeometry, rightLaserMaterial);
// right.parent = worldFrames[Mode.LASERS];
    // right.position.set(0.0, 0.0, 0.0);
    // right.rotation.x = 0.0;
    // right.rotation.y = 0.0;
    // right.rotation.z = 0.0;
    // right.scale.set(1.0, 1.0, 1.0);
scenes[Part.LASERS].add(right);
